...
Manual Deployment
See docs/azure-deployment-guide.md for step-by-step Azure setup.
...
Documentation
Development Notes - Sprint progress and technical decisions
Azure Deployment Guide - Cloud setup instructions
Visual Documentation - Screenshots, wireframes, demo video
